...
if not exist .git (
    echo [!] Initsializuyemo novyi git...
    git init
    git branch -M main
)

echo [*] Nalashhtuvannya adresu repozytoriyu (origin)...
git remote add origin https://github.com/DeFexNN/helensi_book_reader.git 2>nul
git remote set-url origin https://github.com/DeFexNN/helensi_book_reader.git
...
call npx -y gh-pages -d public -e . -m "Auto-deploy static build for GitHub Pages"
